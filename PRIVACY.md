...
HTDemucs and pyannote model files are fetched during setup. During audio processing, Hugging Face offline mode is enabled, pyannote metrics and Hugging Face telemetry are disabled, and audio is not uploaded by the enhancement stage.
